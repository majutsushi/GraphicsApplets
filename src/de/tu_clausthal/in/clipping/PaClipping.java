/*
 * GraphicsApplets/PaClipping.java - Part of the Clipping Applet
...
public class PaClipping extends JApplet {
	public Frame m_frame = null;
	protected PvViewer m_viewer;

	public String getAppletInfo() {
		return "Clipping Applet";
	}
	...
	public void init() {
		...
		PjClipping clipping = new PjClipping();
		m_viewer.addProject(clipping);
		m_viewer.selectProject(clipping);
